-- 직급 코드 삽입
INSERT INTO code (group_code, code, name, created_at, updated_at) VALUES
...
-- 부서 데이터 삽입
INSERT INTO dept (dept_name, created_at, updated_at) VALUES
                                                         ('인사팀', SYSDATE(), SYSDATE()),
                                                         ('개발팀', SYSDATE(), SYSDATE()),
                                                         ('영업팀', SYSDATE(), SYSDATE());

-- 관리자 멤버 정보 삽입 (비밀번호: '123456q!')
INSERT INTO member_info (birth, email, password, created_at, updated_at) VALUES
...
INSERT INTO member (name, dept_id, position_id, join_date, role, member_info_id, created_at, updated_at) VALUES
